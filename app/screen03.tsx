  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.description}>
        For your security, <Text style={styles.boldText}>Peak-Power</Text> wants to make sure it’s really you. 
        <Text style={styles.boldText}> Peak-Power </Text> will send a text message with a 6-digit verification code. 
